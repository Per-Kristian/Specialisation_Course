...
A large portion of the PA (and CA) authentication systems in literature had participants writing text freely during the data collection phase of the experiments, with the exception of two studies \cite{hu, KIM2017} using static text.
...
Out of the periodic authentication and identification systems, \cite{Messerman, superResults, Pinto2014, Ahmed, hu, park}
The block length used for feature extraction of probes was 500 keystrokes or less for 
...
%NOTE: \cite{vural} is one of three? open databases containing free-text keystroke dynamics. 
...
%The lazy learning algorithm k-Nearest Neighbor is popular
...
\begin{tabular}{ |l|p{2.1cm}|l|p{2.15cm}|p{3cm}|p{2.3cm}|p{2.5cm}|l| } 
 ...
 \cite{Messerman} & 50 - 150 & 50 & Webmail & R and A measures & FMR 2.02\%  FNMR 1.84\% & n-graph latency & Own\\ \hline
 ...
 \cite{Ahmed} & 500 & 53 & Unconstrained & MLP Neural Networks & FMR 0.0152\%, FNMR 4.82\%, ERR 2.13\% & Dwell time, digraph flight time & Own\\\hline
