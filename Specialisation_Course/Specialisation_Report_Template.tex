...
Other distance metrics used in literature are Euclidian \cite{Monrose}, Scaled Euclidian \cite{mondal}, Bhattacharyya \cite{Janakiraman2007} and Correlation \cite{mondal} distances.
...
Lastly, two studies applied the \textit{k-nearest neighbor} lazy learning algorithm.
